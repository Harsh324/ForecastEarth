...
def analyseCountries(Country = ['India','China'],Start_Year = 1901 , End_Year = 2020):
...
def analyseState(Country = 'India' , State = ['Uttar Pradesh' , 'Madhya Pradesh'] , Start_Year = 1901 , End_Year = 2020):
    """"
    # Function Description : 
